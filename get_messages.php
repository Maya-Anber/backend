<?php
// backend/messages/get_messages.php
...
$stmt = $conn->prepare("SELECT m.message_id, m.sender_id, m.receiver_id, u.username AS sender_username, m.message_content, m.sent_date, m.is_read, m.message_type
                        FROM messages m
