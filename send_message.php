<?php
// backend/messages/send_message.php
...
$stmt = $conn->prepare("INSERT INTO messages (sender_id, receiver_id, exchange_request_id, message_content, sent_date, is_read, message_type) VALUES (?, ?, ?, ?, NOW(), 0, 'text')");
